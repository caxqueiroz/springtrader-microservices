...
import io.pivotal.springtrader.web.domain.Search;
...
public class TradeController {
	...
	public String buy(Model model, @ModelAttribute("order") Order order) {
		...
		//check if user is logged in!
				...
				if (!(authentication instanceof AnonymousAuthenticationToken)) {
				    ...
				    Order result = portfolioIntegrationService.sendOrder(order);
	...
	private List<Quote> getQuotes(String companyName) {
		...
		List<CompanyInfo> companies = quotesIntegrationService.getCompanies(companyName);
